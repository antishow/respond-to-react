...
/***/ function(module, exports, __webpack_require__) {
	...
	var _aboutPage = __webpack_require__(220);
	...
	var _todoPage = __webpack_require__(222);
	...
	var AppRouter = _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.IndexRoute, { name: 'home', path: '', component: _homePage2.default }),
			_react2.default.createElement(_reactRouter.Route, { name: 'about', path: 'about', component: _aboutPage2.default }),
			_react2.default.createElement(_reactRouter.Route, { name: 'todo', path: 'todo', component: _todoPage2.default })
		)
	);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'app' },
					_react2.default.createElement(_header2.default, { name: this.name }),
					_react2.default.createElement(
						'div',
						{ className: 'container' },
						this.props.children
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoWidget = __webpack_require__(223);

	var _todoWidget2 = _interopRequireDefault(_todoWidget);
	...
	var ToDoPage = function (_React$Component) {
	    ...
	    function ToDoPage() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ToDoPage).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement(_todoWidget2.default, null)
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoForm = __webpack_require__(224);
	...
	var ToDoWidget = function (_React$Component) {
	    _inherits(ToDoWidget, _React$Component);

	    function ToDoWidget(props) {
	        _classCallCheck(this, ToDoWidget);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ToDoWidget).call(this, props));

	        _this.saveTodos = function () {
	            console.log('Save todos!', _this.state.todos);
	            localStorage.setItem('respond-to-react-todos', JSON.stringify(_this.state.todos));
	        };

	        _this.loadTodos = function () {
	            var defaultTodos = [{ id: 1, todo: "Create a React.js To-Do List", done: false }, { id: 2, todo: "Learn a Flux library", done: false }];

	            return JSON.parse(localStorage.getItem('respond-to-react-todos')) || defaultTodos;
	        };

	        _this.handleUpdateToDo = function (todo, todoIndex) {
	            var newTodos = (0, _reactAddonsUpdate2.default)(_this.state.todos, _defineProperty({}, todoIndex, { $set: todo }));

	            _this.setState({ todos: newTodos }, _this.saveTodos);
	        };

	        _this.handleUpdateNewToDo = function (e) {
	            _this.setState({ newTodo: e.target.value });
	        };

	        _this.handleCreateNewToDo = function (e) {
	            e.preventDefault();

	            _this.setState({
	                newTodo: '',
	                todos: _this.state.todos.concat([{
	                    id: _this.state.todos.length + 1,
	                    todo: _this.state.newTodo,
	                    done: false
	                }])
	            }, _this.saveTodos);
	        };
	        ...
	        _this.state = {
	            todos: _this.loadTodos(),
	            newTodo: ''
	        };
	        return _this;
	    }

	    _createClass(ToDoWidget, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'to-do-widget' },
	                _react2.default.createElement(_todoForm2.default, { newTodo: this.state.newTodo, onChange: this.handleUpdateNewToDo, onSubmit: this.handleCreateNewToDo }),
	                _react2.default.createElement(_todoList2.default, { todos: this.state.todos, onUpdateToDo: this.handleUpdateToDo })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.props.todos.map(function (todo, i) {
							return _react2.default.createElement(ToDoListItem, { key: todo.id, index: i, todo: todo, onUpdate: _this2.props.onUpdateToDo });
						})
					)
				);
			}
	...
	var ToDoListItem = function (_React$Component2) {
		...
		function ToDoListItem() {
			...
			return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ToDoListItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.handleCheckboxClick = function (e) {
				var updatedToDo = {
					id: _this3.props.todo.id,
					todo: _this3.props.todo.todo,
					done: !_this3.props.todo.done
				};

				_this3.props.onUpdate(updatedToDo, _this3.props.index);
		...
		_createClass(ToDoListItem, [{
			key: "render",
			value: function render() {
				var checkboxLabel = this.props.todo.todo;
				if (this.props.todo.done) {
					checkboxLabel = _react2.default.createElement(
						"s",
						null,
						checkboxLabel
					);
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"label",
							null,
							_react2.default.createElement("input", { type: "checkbox", name: "done", checked: this.props.todo.done, onClick: this.handleCheckboxClick }),
							checkboxLabel
						)
					)
				);
